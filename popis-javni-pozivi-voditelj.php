...
Dnevnik::DodajAktivnost($korisnikDnevnik, 2, 'Pregled popisa javnih poziva', Postavke::VirtualnoVrijeme());

$smarty->display('templates/zaglavlje.tpl');
$smarty->display('templates/popis-javni-poziv-voditelj.tpl');
